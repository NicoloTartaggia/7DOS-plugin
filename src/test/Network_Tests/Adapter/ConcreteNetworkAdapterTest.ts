...
describe("ConcreteNetworkAdapter - getNodeList", () => {
    ...
    it("Base case", () => {
      ...
      expect(JSON.stringify(nodeOne)).to.equal('{"node":{"name":"Example2","values":["Low Range","Normal Range","Alert Range"],"value":-1,"parents":[],"wasSampled":false,"cpt":[null,null]},"values":[{"valueName":"Low Range","minRange":0,"maxRange":10},{"valueName":"Normal Range","minRange":11,"maxRange":80},{"valueName":"Alert Range","minRange":81,"maxRange":100}]}');
    });
});