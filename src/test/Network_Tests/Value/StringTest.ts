...
describe("StringValue - constructor", () => {
  it("Undefined name - Error", () => {
    let str: string;
    expect(() => new StringValue("value1", str)).to.throw(Error, "[7DOS G&B][StringValue]constructor - invalid name parameter");
  });
  it("Empty name - Error", () => {
    expect(() => new StringValue("value1", "")).to.throw(Error, "[7DOS G&B][StringValue]constructor - invalid name parameter");
  });
  it("Undefined value - Error", () => {
    let str: string;
    expect(() => new StringValue(str, "name1")).to.throw(Error, "[7DOS G&B][StringValue]constructor - invalid value parameter");
  });
  it("Empty value - Error", () => {
    expect(() => new StringValue("", "name1")).to.throw(Error, "[7DOS G&B][StringValue]constructor - invalid value parameter");
  });
...
describe("StringValue - isValueType", () => {
  ...
  it("Empty value - Error", () => {
    ...
    expect(() => stringV.isValueType("")).to.throw(Error, "[7DOS G&B][StringValue]isValueType - invalid value parameter");
  });
  ...
  it("Undefined value - Error", () => {
    ...
    let str: string;
    expect(() => stringV.isValueType(str)).to.throw(Error, "[7DOS G&B][StringValue]isValueType - invalid value parameter");
  });
  it("Empty value - Error", () => {
