...
describe("Datasource - constructor", () => {
    it("Empty url - Error", () => {
        expect(() => new DataSource("", "database")).to.throw(Error, "invalid parameter");
    });
    ...
    it("Empty type - Error", () => {
        expect(() => new DataSource("http://localhost", "database", "username", "password", "")).to.throw(Error, "invalid parameter");
    });
    it("Empty name - Error", () => {
        expect(() => new DataSource("http://localhost", "database", "username", "password", "type", "")).to.throw(Error, "invalid parameter");
    });
});
