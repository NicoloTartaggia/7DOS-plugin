...
export class DataProcessor {
  ...
  public getAutoDetectXAxisMode (firstItem) {
  ...
  public setPanelDefaultsForNewXAxisMode () {
    switch (this.panel.xaxis.mode) {
      case "time": {
  ...
  public timeSeriesHandler (seriesData, index, options) {
  ...
  public validateXAxisSeriesValue () {
    switch (this.panel.xaxis.mode) {
      case "series": {
  ...
  public getDataFieldNames (dataList, onlyNumbers) {
  ...
  public getXAxisValueOptions (options) {
    if (this.panel.xaxis.mode === "series") {
      return [
        {text: "Avg", value: "avg"},
        {text: "Min", value: "min"},
  ...
  public pluckDeep (obj: any, property: string) {
